   ...
   getTestBed().initTestEnvironment(BrowserDynamicTestingModule, platformBrowserDynamicTesting());`,
      ...
      postprocessor: wallabyWebpack({
        ...
        resolve: {
          ...
          alias: {
            '@models': path.join(wallaby.projectCacheDir, 'src/app/models'),
            '@providers': path.join(wallaby.projectCacheDir, 'src/app/providers'),
            '@shared': path.join(wallaby.projectCacheDir, 'src/app/shared'),
            '@state': path.join(wallaby.projectCacheDir, 'src/app/state'),
          },
        },
      }),
